...
public class FactureRestController {
	...
	@PostMapping("/add-facture/{fournisseur-id}")
	@ResponseBody
	public Facture addFacture(@RequestBody Facture f, @PathVariable("fournisseur-id") Long fournisseurId) {
		Facture facture = factureService.addFacture(f, fournisseurId);
		return facture;
	}
	...
	/* récupérer la liste des factures d'un fournisseur donné */
	...
	// http://localhost:8089/SpringMVC/facture/assignOperateurToFacture/1/1
			...
			/*Pourcentage recouvrement :total reglement / total facture entre deux dates*/
